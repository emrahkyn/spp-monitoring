...
def get_column(StringNum):
    column_name=["Time"];
    for i in range(1,StringNum+1):
        column_name.append("Upv"+str(i));
    for i in range(1,StringNum+1):
        column_name.append("Ipv"+str(i));

    tmp_str=["Uac1","Uac2","Uac3","Iac1","Iac2","Iac3","Status","Error","Temp","cos","fac","Pac","Qac","Eac","Cycle Time"];
    for i in tmp_str:
...
### global variables ####
#col_names=["Time","Upv1","Upv2","Upv3","Upv4","Upv5","Upv6","Upv7","Upv8","Upv9","Upv10","Upv11","Upv12","Upv13","Upv14","Upv15","Upv16","Upv17","Upv18","Upv19","Upv20",
...
col_names = get_column(int(os.environ['STRING_NUM']));
